...
//        webView.loadUrl("http://www.google.com");
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://kr.ogong.gibiyo.gibiyoforuser/http/host/path")
        );
            ...
            if (url.startsWith(INTENT_PROTOCOL_START)) {
                ...
                if (customUrlEndIndex < 0) {
                    ...
                    try {
                        ...
                        ((Activity) view.getContext()).startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(customUrl)));
